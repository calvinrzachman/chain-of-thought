...
Bitcoin is many different things to different people. For some, Bitcoin is hope, for others [Bitcoin is freedom](https://www.youtube.com/watch?v=xLYYh4aPXAM), yet others still - [Bitcoin is Time](https://dergigi.com/2021/01/14/bitcoin-is-time/). Metaphor and philosophical musing aside, for the purposes of this summary Bitcoin is two things: *Bitcoin is a software protocol for **cooperatively** building a list*. The list produced forms the basis of a global, censorship resistant, monetary settlement network, and *bitcoin is the accounting unit* native to the list, or ledger, that software protocol maintains. The latter concerns what is owned, while the former concerns the system which enables *digital scarcity* and ownership without central authority in the first place. 
...
So we have Bitcoin, the network - a collection of individuals cooperatively building a ledger - and bitcoin, the asset - a number in that ledger.
